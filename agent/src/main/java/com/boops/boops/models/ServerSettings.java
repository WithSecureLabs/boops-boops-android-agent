package com.boops.boops.models;

import android.content.SharedPreferences;
import android.content.SharedPreferences.OnSharedPreferenceChangeListener;

import com.boops.boops.Agent;
import com.boops.jdiesel.api.connectors.Server;
...
public class ServerSettings implements OnSharedPreferenceChangeListener {
	...
	private char[] getKeyPassword() {
		return this.getSettings().getString(Server.SERVER_KEY_PASSWORD, "yaypasswordyay").toCharArray();
	}
	
	private char[] getKeyStorePassword() {
		return this.getSettings().getString(Server.SERVER_KEYSTORE_PASSWORD, "yaypasswordyay").toCharArray();
	}
	
	private String getKeyStorePath() {
		return this.getSettings().getString(Server.SERVER_KEYSTORE_PATH, "/data/data/live.hatch.russa/files/boopsboops.bks");
	}
