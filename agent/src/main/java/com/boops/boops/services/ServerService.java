package com.boops.boops.services;
...
import com.boops.boops.models.ServerSettings;
import com.boops.jdiesel.api.connectors.Connector;
import com.boops.jdiesel.api.links.Server;
...
public class ServerService extends ConnectorService {
	...
	private com.boops.jdiesel.api.connectors.Server server_parameters = new com.boops.jdiesel.api.connectors.Server();

	public Bundle getDetailedStatus() {
		Bundle data = new Bundle();

		data.putBoolean(Connector.CONNECTOR_ENABLED, server_parameters.isEnabled());
		data.putBoolean(com.boops.jdiesel.api.connectors.Server.SERVER_PASSWORD, server_parameters.hasPassword());
		data.putBoolean(com.boops.jdiesel.api.connectors.Server.SERVER_SSL, server_parameters.isSSL());
	...
	public int onStartCommand(Intent intent, int flags, int startId){
		...
		if(intent != null && intent.getCategories() != null && intent.getCategories().contains("com.boops.boops.START_EMBEDDED")) {
