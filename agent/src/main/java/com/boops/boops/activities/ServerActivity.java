...
import com.boops.boops.views.CheckListItemView;
import com.boops.boops.views.ConnectorStatusIndicator;
import com.boops.boops.views.logger.LogMessageAdapter;
...
public class ServerActivity extends ConnectorActivity implements Observer, Server.OnDetailedStatusListener {
	...
	protected void startServer() {
		try {
			...
			this.parameters.setStatus(com.boops.jdiesel.api.connectors.Server.Status.UPDATING);
