...
public class SettingsActivity extends PreferenceActivity {
	...
	public static final String ABOUT_BOOPSBOOPS_PREFERENCE = "about_boopsboops";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		this.about_preference = (Preference)this.findPreference(ABOUT_BOOPSBOOPS_PREFERENCE);
