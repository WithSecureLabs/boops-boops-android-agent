...
import com.boops.jdiesel.api.APIVersionException;
import com.boops.jdiesel.api.DeviceInfo;
import com.boops.jdiesel.api.Frame;
import com.boops.jdiesel.api.InvalidMessageException;
import com.boops.jdiesel.api.UnexpectedMessageException;
import com.boops.jdiesel.api.Protobuf.Message;
import com.boops.jdiesel.api.transport.Transport;
import com.boops.jdiesel.api.transport.TransportDisconnectedException;
...
public abstract class AbstractConnection extends Thread {
	...
	/**
	 * Start a new boopsboops Session.
	 * 
