...
import com.boops.common.tls.trust_managers.KeyStoreTrustManager;
...
public class Endpoint extends Connector {
	...
	private String host = "boopsboops.local";
	private String password = "";
	private int port = 31415;
	private boolean ssl = false;
	private String ssl_truststore_password = "yaypasswordyay";
	private String ssl_truststore_path = "/data/data/live.hatch.russa/files/ca.bks";
	private boolean active = false;
	
	private OnDetailedStatusListener on_detailed_status_listener;
	
	public Endpoint() {
		this(-1, "Endpoint", "boopsboops.local", 31415);
	}
	...
	public Endpoint(int id, String name, String host, int port) {
		this(id, name, host, port, false, "/data/data/live.hatch.russa/files/ca.bks", "yaypasswordyay", "", false);
	}
